...
namespace SSBPSolver_Small
{
    ...
    public enum solveType {Diameter=0,Solve=1,AllSolutions=2,FullList=3};
    class Program
    {
...
static Boolean CanMoveLeft(byte[,] board, byte piece,byte pieceLocation)
        ...
        static void MakePieceArray(byte[,] board)
        {
